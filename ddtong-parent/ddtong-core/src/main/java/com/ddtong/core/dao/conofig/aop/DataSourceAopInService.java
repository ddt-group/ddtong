...
import com.ddtong.core.dao.conofig.dbconfig.DataSourceType;
...
/*	@Before("execution(* com.ddtong.service..*.find*(..)) "
			+ " or execution(* com.ddtong.service..*.get*(..)) "
			+ " or execution(* com.ddtong.service..*.query*(..))")
    ...
    @Before("execution(* com.ddtong.service..*.insert*(..)) "
    		+ " or execution(* com.ddtong.service..*.update*(..))"
    		+ " or execution(* com.ddtong.service..*.add*(..))")
    public void setWriteDataSourceType() {
        DataSourceContextHolder.setWrite();
    }*/
    

	@Before("execution(* com.ddtong.service..*.*(..)) "
